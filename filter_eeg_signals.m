function [xrt,rawt] = filter_eeg_signals(f_low,f_high,he) 

% Created by Irene Vigué-Guix
% February 5th 2020 - Barcelona, Catalonia, Spain

%Modified by Ivan Garcia
%May 15 2020  Qro, Mexico.
...
%he = 1;
if he == 1
    T = table(EEG, 'VariableNames', { 'signals'} );
    writetable(T, 'data_eeg.txt')
end
