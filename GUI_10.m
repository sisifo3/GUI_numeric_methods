...
% GUI_10 MATLAB code for GUI_10.fig
...
%
%      GUI_10('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_10.M with the given input arguments.
%
%      GUI_10('Property','Value',...) creates a new GUI_10 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GUI_10_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GUI_10_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 30-Jun-2020 02:16:41
...
% varargin   command line arguments to GUI_10 (see VARARGIN)
...
f_high = handles.n;
h = handles.hn;
filter_eeg_signals(f_low,f_high,h) 
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
hn = str2double(get(hObject,'String'));
handles.hn = hn;
guidata(hObject,handles)
%h for save txt
